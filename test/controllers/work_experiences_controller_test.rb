...
class WorkExperiencesControllerTest < ActionController::TestCase
  ...
  test "should create work_experience" do
    assert_difference('WorkExperience.count') do
      post :create, work_experience: { company: @work_experience.company, description: @work_experience.description, enddate: @work_experience.enddate, startdate: @work_experience.startdate }
    end
  ...
  test "should update work_experience" do
    patch :update, id: @work_experience, work_experience: { company: @work_experience.company, description: @work_experience.description, enddate: @work_experience.enddate, startdate: @work_experience.startdate }
    assert_redirected_to work_experience_path(assigns(:work_experience))
  end
